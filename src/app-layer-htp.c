...
SCEnumCharMap http_decoder_event_table[] = {
    ...
    { "MCP_AGENT_CARD", HTTP_DECODER_EVENT_MCP_AGENT_CARD },
    ...
    { "MCP_STAGE_INIT", HTTP_DECODER_EVENT_MCP_STAGE_INIT },
    ...
    { "MCP_STAGE_RPC", HTTP_DECODER_EVENT_MCP_STAGE_RPC },
    ...
    { "MCP_STAGE_STREAM", HTTP_DECODER_EVENT_MCP_STAGE_STREAM },
    ...
    { "MCP_ANOMALY", HTTP_DECODER_EVENT_MCP_ANOMALY },
